...
@WebServlet("/add-study-plan")
public class AddStudyPlanServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        out.println("<title>StudySync - Add Study Plan</title>");
        ...
        out.println("<h1>Add Study Plan</h1>");

        out.println("<p class='subtitle'>");
        out.println("Create a structured plan for your studies.");
        out.println("</p>");

        out.println("<form action='add-study-plan' method='post'>");

        out.println("<label>Plan Title</label>");

        out.println("<input type='text' "
                + "name='title' "
                + "placeholder='Example: Complete Java Collections' "
                + "required>");

        out.println("<label>Description</label>");

        out.println("<textarea name='description' "
                + "placeholder='Describe what you want to complete in this plan' "
                + "required></textarea>");
        ...
        out.println("<option value='PLANNED'>PLANNED</option>");
    ...
    protected void doPost(HttpServletRequest request,
        ...
        studyPlanDAO.addStudyPlan(studyPlan);
