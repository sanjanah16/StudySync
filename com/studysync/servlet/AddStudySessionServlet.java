...
@WebServlet("/add-study-session")
public class AddStudySessionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        out.println("<title>StudySync - Add Study Session</title>");
        ...
        out.println("box-shadow: 0 0 0 3px rgba(102,126,234,0.1);");
        out.println("}");
        ...
        out.println("<h1>Add Study Session</h1>");

        out.println("<p>");
        out.println("Record your study time and track your learning progress.");
        out.println("</p>");

        out.println("</div>");

        out.println("<form action='add-study-session' method='post'>");
        ...
        out.println("<textarea name='notes' " +
                "placeholder='What did you learn in this session?'></textarea>");
        ...
        out.println("Save Study Session");
        out.println("</button>");
    ...
    protected void doPost(HttpServletRequest request,
        ...
        Date sessionDate =
                Date.valueOf(sessionDateString);

        Time startTime =
                Time.valueOf(startTimeString + ":00");
        ...
        sessionDAO.addStudySession(studySession);
